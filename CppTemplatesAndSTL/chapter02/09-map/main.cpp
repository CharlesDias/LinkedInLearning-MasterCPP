...
int main()
{
   ...
   map<string, string> mapstr = {{"George", "Father"}, {"Ellen", "Mother"}, {"Ruth", "Daughter"}, {"Spike", "Neighbor's Son"}};
   ...
   multimap<string, string> mapstr2 = {{"George", "Father"}, {"Ellen", "Mother"}, {"Ruth", "Daughter"}, {"Spike", "Neighbor's Son"}};
   print_map(mapstr2);

   cout << "insert a duplicate in multimap:" << endl;
   mapstr2.insert({"George", "Father"});
   message("size", mapstr2.size());
   print_map(mapstr2);
