...
int main()
{
   ...
   message("construct set set3 - able to duplicate elements");
   multiset<string> set3 = {"one", "two", "three", "four", "five"};
   message("size of set", set3.size());
   message("ordered set is alphabetical");
   print_set(set3);
   cout << endl;
   ...
   message("construct unordered multi set set4");
   unordered_multiset<string> set4 = {"one", "two", "three", "four", "five"};
   message("size of set", set4.size());
   message("unordered set has no defined order");
   print_set(set4);
   cout << endl;
